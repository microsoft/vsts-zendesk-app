...
(function() {
    ...
    var INSTALLATION_ID = 0, //For dev purposes, when using Zat, set this to your current installation id
    ...
    return {
        ...
        requests: {
            ...
            getVsoProjects: function(skip) {
                return this.vsoRequest("/_apis/projects", { $top: VSO_PROJECTS_PAGE_SIZE, $skip: skip || 0 });
            },
            ...
            getVsoProjectAreas: function(projectId) {
                return this.vsoRequest(helpers.fmt("/%@/_apis/wit/classificationnodes/areas", projectId), { $depth: 9999 });
            },
            getVsoProjectWorkItemQueries: function(projectName) {
                return this.vsoRequest(helpers.fmt("/%@/_apis/wit/queries", projectName), { $depth: 2 });
            },
            getVsoFields: function() {
                return this.vsoRequest("/_apis/wit/fields");
            },
            getVsoWorkItems: function(ids) {
                return this.vsoRequest("/_apis/wit/workItems", { ids: ids, $expand: "relations" });
            },
            getVsoWorkItem: function(workItemId) {
                return this.vsoRequest(helpers.fmt("/_apis/wit/workItems/%@", workItemId), { $expand: "relations" });
            },
        ...
        onNewWorkItemClick: function() {
            ...
            this.ajax("getComments").done(
                function(data) {
                    ...
                    $modal
                        .find(".modal-body")
                        .html(this.renderTemplate("new", { attachments: attachments, templateDefined: templateDefined }));
        ...
        onSettingChange: function() {
            ...
            this.ajax("saveSettings", { vso_field_settings: JSON.stringify(fieldSettings) }).done(
                function() {
        ...
        onLinkQueryButtonClick: function() {
            ...
            var drawQueryResults = function(results, countQueryItemsResult) {
                ...
                $modal
                    .find(".alert-success")
                    .html(this.I18n.t("queryResults.returnedWorkItems", { count: countQueryItemsResult }));
                this.hideSpinnerInModal($modal);
            }.bind(this);
        ...
        onUnlinkAcceptClick: function(event) {
            ...
            var updateWorkItem = function(workItem) {
                ...
                if (posOfLinksToRemove.length === 0) {
                    ...
                    var operations = [{ op: "test", path: "/rev", value: workItem.rev }].concat(
                        _.map(
                            posOfLinksToRemove,
                            function(pos) {
